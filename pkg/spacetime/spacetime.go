...
import (
	...
	"github.com/obinexusmk2/ltcodec/pkg/identity"
)
...
// computeFingerprint computes the SHA-256 hash of the state.
...
// Implements the delta-T replay described in the Turing machine model.
